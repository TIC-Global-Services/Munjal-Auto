const committees = () => {
  ...
  return (
    <div className="mt-10 px-5 lg:px-20 lg:p-10 overflow-x-hidden w-full">
     <div>
       <div>
        <h1 className="lg:text-[46px] translate-x-[-12px] text-[22px] leading-[60px] whitespace-nowrap lg:whitespace-normal">
     ...
     <div>
      ...
      <div className="flex gap-5 flex-wrap lg:flex-nowrap justify-center lg:mt-10 mt-5">
        {CorporateSocialResponsibilityCommitteeList.map((res, index) => (
         ...
         <div>
        <div>
        <h1 className="text-[16px] lg:text-[24px] mt-10">Share Transfer Committee</h1>
      </div>
      <div className="flex gap-5 flex-wrap lg:flex-nowrap items-start justify-start lg:mt-10 mt-5">
