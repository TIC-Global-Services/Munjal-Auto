      ...
      <div className="w-[94%] max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="space-y-6 max-gap-4xl">
            {/* Paragraphs */}
            <p className="text-[14px] md:text-lg lg:text-xl xl:text-[20px] font-[400] leading-relaxed text-gray-700">
            ...
            <ul className="space-y-3 pt-4">
              <li className="flex items-start gap-2 text-[14px] md:text-lg lg:text-xl xl:text-[20px] font-[400] leading-relaxed text-gray-600">
                <span className="text-[#82848A] flex-shrink-0">•</span>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-[#F5F5F5] rounded-[14px] p-6 sm:p-8">
              ...
              <p className="text-[14px] sm:text-lg md:text-[18px] font-[400] leading-relaxed text-gray-700">
            ...
            <div className="bg-[#F5F5F5] rounded-[14px] p-6 sm:p-8">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start gap-2 text-[14px] sm:text-lg md:text-[20px] font-[400] leading-relaxed text-gray-700">
                  ...
                  <div className="py-4 sm:py-6 px-6 sm:px-8 md:px-12 flex flex-col justify-start relative">
                    ...
                    <ul className="space-y-1 sm:space-y-2 mb-16 sm:mb-20">
                      {competencies[currentCard].points.map((point, index) => (
                        <li key={index} className="text-[14px] sm:text-base md:text-[16px] font-[400] leading-relaxed sm:leading-[34px] text-[#82848A]">
                          • {point}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <div className="bg-transparent pb-8 lg:pb-12">
              ...
              <div className="pt-6 sm:pt-8">
                ...
                <p className="text-[14px] sm:text-lg md:text-[16px] font-normal leading-relaxed sm:leading-[34px] text-gray-600">
            ...
            <div className="bg-transparent pb-8 lg:pb-12">
              ...
              <div className="pt-4 sm:pt-6">
                ...
                <p className="text-[14px] sm:text-lg md:text-[16px] font-[400] leading-relaxed sm:leading-[34px] text-gray-600">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-32 items-center">
            ...
            <div className="space-y-4 sm:space-y-5 order-1 lg:order-2">
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start gap-2 sm:gap-3 text-[14px] sm:text-lg md:text-[20px] font-[400] leading-relaxed sm:leading-[30px] text-[#82848A]">
                  <span className="text-[#82848A] flex-shrink-0">•</span>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="bg-white rounded-[20px] p-6 sm:p-8 md:p-10 relative overflow-hidden">
                <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-center relative z-10">
                  <div className="w-full max-w-[500px] md:w-[500px] aspect-square rounded-[12px] md:rounded-[12px] overflow-hidden flex-shrink-0 relative -ml-2 md:-ml-6 pl-4 md:pl-8">
                    <img
                      src={founder1}
                      alt="Mr. Kulvinder Singh Seehra"
                      className="w-full h-full object-cover scale-100 rounded-[12px] md:rounded-[12px]"
                    />
                  </div>
              ...
              <div className="bg-white rounded-[20px] p-6 sm:p-8 md:p-10 relative overflow-hidden">
                <div className="flex flex-col md:flex-row-reverse gap-6 sm:gap-8 items-center relative z-10">
                  <div className="w-full max-w-[500px] md:w-[500px] aspect-square rounded-[12px] md:rounded-[20px] overflow-hidden flex-shrink-0 relative -mr-2 md:-mr-6 pr-4 md:pr-8">
                    <img
                      src={founder2}
                      alt="Mr. Sandeep Agrgawal"
                      className="w-full h-full object-cover scale-100 rounded-[12px] md:rounded-[20px]"
                    />
                  </div>
