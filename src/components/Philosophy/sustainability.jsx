...
const sustainability = () => {
    ...
    const bulletPoints=["Over two decades of environmental management including waste management, energy conservation, and pollution control",
