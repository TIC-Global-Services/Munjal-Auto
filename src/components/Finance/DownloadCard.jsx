...
const DownloadCard = ({ title, dateRange, pdfUrl }) => {
  ...
  const shareTitle = `${title} - ${dateRange}`
  const shareText = `Check out this report: ${shareTitle}`
  ...
  return (
    <>
      <div className="bg-[#E8E8E8] rounded-2xl p-4 text-gray-800 max-w-sm">
        <div className="text-center mb-6 border p-6 rounded-2xl border-gray-400">
          <p className="text-gray-600 text-sm mb-4">Download the report here</p>
        ...
        <div className="text-left">
          ...
          <p className="text-gray-800 font-medium text-xl">{dateRange}</p>
        </div>
      </div>
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md">
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-600 mb-2">Sharing: {title}</p>
              <p className="text-xs text-gray-500 bg-gray-50 p-2 rounded truncate">{shareUrl}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {shareOptions.map((option) => (
                <button
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg border transition-colors ${option.color}`}
                >
                  {option.icon}
